    ...
    <ModalBody>
      <Option onClick={() => setSelected('largeSet')}>
        <OptionSelectedWrapper>
          <OptionSelected src={`modal/ic_${selected === 'largeSet' ? '' : 'un'}checked.png`}/>
        </OptionSelectedWrapper>
        <OptionDetail>
      ...
      <Option onClick={() => setSelected('set')}>
        <OptionSelectedWrapper>
          <OptionSelected src={`modal/ic_${selected === 'set' ? '' : 'un'}checked.png`}/>
        </OptionSelectedWrapper>
        <OptionDetail>
      ...
      <Option onClick={() => setSelected('normal')}>
        <OptionSelectedWrapper>
          <OptionSelected src={`modal/ic_${selected === 'normal' ? '' : 'un'}checked.png`}/>
        </OptionSelectedWrapper>
        <OptionDetail>
